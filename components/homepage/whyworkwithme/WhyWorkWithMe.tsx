    ...
    <section className="py-20  relative">
      <div className="max_width px-5">
        ...
        >
          ...
          <motion.div variants={fadeIn("up", "spring")} className='flex flex-col md:flex-row mt-1'>
            <div className='bg-third_color py-9 px-12 text-primary_color w-full md:w-[75%] flex gap-5 font-fraunces'>
            ...
            <motion.div variants={fadeIn("up", "spring")}  className='w-[25%] flex flex-col justify-center pl-5'>
              <p className='opacity-70 text-sm '>Ready To Start?</p>

              <Link href="/contact" className="py-3 px-7 border self-start mt-1 bg-third_color text-primary_color group">
